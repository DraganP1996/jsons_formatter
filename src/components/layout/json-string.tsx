...
export const JSONString = ({ initialValue }: JSONStringProps) => {
  ...
  return (
    <div className="grid grid-cols-[2fr,1fr,2fr] h-[calc(100vh-99px)] overflow-hidden">
      <Editor isReady={isReadyToLoadEditor} value={source} theme="" />
      <BeautifierControls tabSize={tabSize} changeTabSize={setTabSize} changeTheme={() => {}} />
      <Editor isReady={isReadyToLoadEditor} value={result} mode="text/plain" theme="" />
    </div>
  );
};
