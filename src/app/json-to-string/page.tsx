import { JSONString } from "@/components/layout";
...
export default function JSONToStringPage() {
  return (
    <>
      <h1 className="text-xl font-bold p-2 text-center"> JSON to String Converter</h1>
      <JSONString initialValue={JSON.stringify(mockJSON, null, 2)} />
    </>
  );
}
